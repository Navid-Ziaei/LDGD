from LDGD.model.utils.variational import VariationalDist, VariationalLatentVariable, CholeskeyVariationalDist
from LDGD.visualization.vizualize_utils import plot_loss
